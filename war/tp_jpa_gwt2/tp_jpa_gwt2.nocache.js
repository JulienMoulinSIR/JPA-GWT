...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "tp_jpa_gwt2" because\n';
  ...
  $wnd.__gwt_activeModules['tp_jpa_gwt2'] = {
    'moduleName' : 'tp_jpa_gwt2',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/tp_jpa_gwt2.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['tp_jpa_gwt2'].superdevmode = true;

  var expectedSuffix = '/tp_jpa_gwt2.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + tp_jpa_gwt2 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:tp_jpa_gwt2';
  var devModeSessionKey = '__gwtDevModeSession:tp_jpa_gwt2';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/tp_jpa_gwt2/tp_jpa_gwt2.nocache.js';
  ...
  $wnd.__gwt_activeModules['tp_jpa_gwt2'].canRedirect = true;
  $wnd.__gwt_activeModules['tp_jpa_gwt2'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/tp_jpa_gwt2?user.agent=' + ua + '&_callback=' + callback;
